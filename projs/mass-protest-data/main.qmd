...
By checking the last report chart we can see some interesting relations:
...
2. Removing politician is a reason that moves many people (`participants_category`) several times in a year (`protestnumber`) and most of the time takes place in the country capital.
