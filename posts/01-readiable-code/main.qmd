...
- Words like *is*, *has* and *should* are make clearer a boolean variable.
...
After reading each column description it clean why each variable has its name, but it becomes clear that it is impossible for anybody to understand what each variable contains just by reading each name.
